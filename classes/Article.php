...
class Article extends Database {
    ...
    public function deleteArticle($id) {
        ...
        $result = $this->executeNonQuery($sql, [$id]);

        if ($result) {
            $notification = new Notification();
            $message = "Your article '" . $article['title'] . "' has been deleted by an admin.";
            $notification->createNotification($article['author_id'], $message);
        }
